...
const EditServiceForm: React.FC = () => {
  ...
  const { id } = useParams(); // Assuming your route is like /admin/services/edit/:id
  ...
  return (
    ...
    >
      <h2 style={{ color: "black", marginBottom: "1.5rem" }}>Edit Service</h2>
      ...
      >
        ...
        <div className="mb-3">
          ...
          <button type="button" onClick={addFaq} className="btn btn-info mt-2">
            + Add FAQ
          </button>
        </div>
